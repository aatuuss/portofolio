...
const INJECTED_STYLES = `
  ...
  .btn-modern-light:active {
      ...
      ref={overlayRef}
      className={cn(
        "fixed inset-0 z-[100] pointer-events-none cinematic-intro text-white transition-opacity will-change-transform",
        className
      )}
  }
  .btn-modern-dark {
  ...
  return (
    ...
    >
      ...
      <div className="hero-text-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 will-change-transform transform-style-3d">
        <h1 className="text-track gsap-reveal text-5xl md:text-7xl lg:text-[6rem] font-bold tracking-tight mb-2 text-3d-matte">
          {tagline1}
        </h1>
        <h1 className="text-days gsap-reveal text-5xl md:text-7xl lg:text-[6rem] font-extrabold tracking-tighter text-silver-matte">
          {tagline2}
        </h1>
      </div>
